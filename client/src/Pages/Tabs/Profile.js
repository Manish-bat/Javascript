...
class PaperSheet extends React.Component {
  ...
  getUserData = () => {
    ...
    axios
      ...
      .then((res) => {
        const { name, email, age, mobile, dob, gender } = res.data;
        this.setState({ name, email, age, mobile, gender, dob });
      })
      .catch((err) => {
        console.error(err);
      });
  ...
  submitDataHandler = (e) => {
    e.preventDefault();
    const token = window.localStorage.getItem("token");
    const { name, email, age, mobile, gender, dob } = this.state;
    axios
      .patch(
        "/users/me",
      ...
      .then((res) => {
        ...
        const { name, email, age, mobile, gender, dob } = res.data;
        this.setState({ name, email, age, mobile, gender, dob });
      })
      .catch((err) => {
        console.log(err);
    ...
    return (
      <AuthContext>
        {({ error, user }) => {
          ...
          let { name, email, age, mobile, gender, dob } = this.state;
